...
var Code = map[string]int16{
	...
	"get_pike_seed_req":      30, // socket通信加密使用
	"get_pike_seed_ack":      31, // socket通信加密使用
}
...
var RCode = map[int16]string{
	...
	30: "get_pike_seed_req",      // socket通信加密使用
	31: "get_pike_seed_ack",      // socket通信加密使用
}
